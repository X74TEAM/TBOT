...
BOT_TOKEN = "7329447644:AAGsUoD2aXMJPIJ4U3mOGkQRzKVlNpH750k"
PAYMENT_CHANNEL = "@ThePrigMan" #add payment channel here including the '@' sign
OWNER_ID = 1178065322 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@ThePrigMan"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
